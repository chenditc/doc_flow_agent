---
doc_id: tools/python
description: Generate and execute python code for data processing, calculations, REST API calls, complex logic, and file manipulation. It has access to data stored in context dictionary, usually reference by json path.
tool:
