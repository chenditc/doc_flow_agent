...
2. If the information must task some user input, eg. It needs user's name / preference / drug history. Use pattern like: 'Use web_user_communicate.md to ask user "xxxxx"'.
