    ...
    <div className="space-y-6">
          ...
          <div className="p-4">
            ...
            <div className="mt-4">
              ...
              <div className="mt-1 p-3 bg-gray-50 border rounded">
                {sop_document.input_description && Object.keys(sop_document.input_description).length > 0 ? (
      ...
      {input_field_extractions && Object.keys(input_field_extractions).length > 0 && (
        <div className="space-y-4">
          ...
          <div className="space-y-4">
            {Object.entries(input_field_extractions).map(([fieldKey, fieldData]) => (
              <InputFieldExtractionViewer
                key={fieldKey}
                fieldName={fieldData.field_name || fieldKey}
                description={fieldData.description || ''}
                fieldExtraction={fieldData}
              />
            ))}
          </div>
        </div>
          ...
          <div className="p-4">
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="mt-1 p-3 bg-gray-50 border rounded">
                  {created_task.input_json_path && Object.keys(created_task.input_json_path).length > 0 ? (
                    <div className="space-y-2">
